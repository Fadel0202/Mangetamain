...
def mock_recipe_data():
    ...
    with patch(
        "webapp_mangetamain.load_config.get_recipe_data", return_value=mock_recipe_df
    ):
        with patch(
            "webapp_mangetamain.load_config.get_recipe_rating_data",
            return_value=mock_rating_df,
        ):
            ...
            with patch("pandas.read_csv") as mock_read_csv:
                ...
                yield {"recipe": mock_recipe_df, "recipe_rating": mock_rating_df}
